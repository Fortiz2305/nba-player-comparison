...
const steps = [
  {
    ...
    description:
      "Los datos provienen de Basketball Reference. Se obtienen las estadísticas universitarias (NCAA) de todos los jugadores drafteados entre 2005 y 2025 que pasaron por la universidad americana. Más de 1.200 jugadores NBA cuando aún estaban en NCAA.",
    icon: (
